...
def run_ppo(config, task_runner_class=None) -> None:
    ...
    if not ray.is_initialized():
        ...
        ray_init_kwargs = OmegaConf.create({**ray_init_kwargs, "runtime_env": runtime_env, "num_cpus": 16})
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        val_reward_fn = load_reward_manager(
            config, tokenizer, num_examine=10, **config.reward_model.get("reward_kwargs", {})
        )
